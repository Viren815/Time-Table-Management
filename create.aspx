<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="Time_Table_Management.create" %>
...
<body>
    ...
    <section class="table1 cid-qThwW0ZSe5" id="table1-7">
        ...
        <div class="container" id="CreateTable" runat="server">
            <div class="mbr-row mbr-justify-content-center">
                <div class="mbr-col-md-12 mbr-col-lg-12 mbr-col-sm-12">
                    <h2 class="mbr-fonts-style main-title mbr-black align-center mbr-bold display-3">CREATE TIMETABLE</h2>
                              ...
                              <td class="time1">
                                  ...
                                  <td >
                                            <div class="box">
                                                ...
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r1c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r1c11" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r1c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r1c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r1c21" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r1c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r1c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r1c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r1c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r1c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r1c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r1c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r1c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r1c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r1c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td></tr>
                               <tr>
                                    ...
                                    <td class="time1">
                                     ...
                                     <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r2c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r2c11" runat="server" placeholder="Year"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r2c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r2c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r2c21" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r2c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r2c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r2c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r2c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r2c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r2c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r2c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r2c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r2c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r2c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td></tr>
                                    ...
                                    <td class="time1">
                                         ...
                                         <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r3c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r3c11" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r3c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r3c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r3c21" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r3c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r3c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r3c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r3c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r3c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r3c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r3c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r3c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r3c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r3c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td></tr>
                                    <%--<tr>--%>
                                    ...
                                    <td class="time1">
                                          ...
                                          <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r4c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r4c11" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r4c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r4c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r4c21" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r4c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r4c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r4c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r4c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r4c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r4c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r4c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r4c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r4c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r4c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <td class="time1">
                                            ...
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r5c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r5c11" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r5c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r5c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r5c21" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r5c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r5c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r5c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r5c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r5c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r5c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r5c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r5c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r5c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r5c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td></tr>
                                    <tr>
                                    ...
                                    <td class="time1">
                                         ...
                                         <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r6c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r6c11" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r6c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r6c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r6c21" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r6c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r6c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r6c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r6c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r6c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r6c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r6c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r6c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r6c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r6c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td></tr>
                                    <tr>
                                    <td class="time1">
                                          ...
                                          <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r7c1" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r7c11" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r7c12" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r7c2" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r7c21" runat="server" placeholder="Year"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r7c22" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r7c3" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r7c31" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r7c32" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r7c4" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r7c41" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r7c42" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                  <td >
                                            <div class="box">
                                                <h2 class="mbr-fonts-style type1 mbr-bold display-7">
                                                <%--<input type="text" name="" id="r1c1" placeholder="Name of subject">--%>
                                                    <asp:TextBox ID="r7c5" runat="server" placeholder="Name of Subject"></asp:TextBox>
                                                </h2>
                                                <h3><asp:TextBox ID="r7c51" runat="server" placeholder="Class"></asp:TextBox></h3>
                                                <h4><asp:TextBox ID="r7c52" runat="server" placeholder="Location"></asp:TextBox> </h4>
                                            </div>
                                        </td>
                                        </tr>
                                </tbody>
    ...
    <%--<asp:Button ID="a" runat="server" Text="Button" OnClick="abc" Enabled="true" />--%>
        <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="abc" CssClass="btn btn-md btn-primary display-6" align="Center"/>
   </section>
    <!-------Display Table----->
    ...
    <%--<section class="table1 cid-qThwW0ZSe5" id="table1-7">
        ...
        <div class="container">
            <div class="mbr-row mbr-justify-content-center">
                <div class="mbr-col-md-12 mbr-col-lg-12 mbr-col-sm-12">
                    <h2 class="mbr-fonts-style main-title mbr-black align-center mbr-bold display-3">YOUR TIMETABLE</h2>

                    <div class="wrapscroll">
                        <div class="scroll">

                            <table class="table mbr-text mbr-fonts-style"id = "display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                      <th class="time1">
                                              <p class="mbr-text tabletitle mbr-fonts-style display-7"></p>
