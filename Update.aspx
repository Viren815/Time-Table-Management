<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Time_Table_Management.Update" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update your schedule</title>
...
<body>
        ...
        <div class="container">
            <div class="mbr-row mbr-justify-content-center">
                <div class="mbr-col-md-12 mbr-col-lg-12 mbr-col-sm-12">
                    <h2 class="mbr-fonts-style main-title mbr-black align-center mbr-bold display-3">UPDATE TIMETABLE</h2>
    ...
    <%--<asp:Button ID="a" runat="server" Text="Button" OnClick="abc" Enabled="true" />--%>
        <asp:Button ID="Button1" runat="server" Text="Update" CssClass="btn btn-md btn-primary display-6" align="Center" OnClick="Button1_Click"/>
   </section>
    </form>
</body>
</html>
